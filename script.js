...
let options = {
    fruits:["Mango",'Lychee',"Orange","Avacado","Kiwi","Grapes"],
    animals:["Fox","Tiger","Liger","Parrot","Turtle","Fish","lobster"],
    countries:["Mexico","Pakistan","Germany","China","Japan","Yemen","Egypt"]
}
